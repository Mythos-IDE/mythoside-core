use mythoside_common::{now_iso8601, slugify};
use mythoside_narrative::{Book, Chapter, Character, Location, Note, NoteType, Series};
use mythoside_parser as format;
...
pub fn list_series_in(base_dir: &Path) -> ListSeriesOutput {
